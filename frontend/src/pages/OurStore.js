              ...
              <div className='filter-card mb-3'>
                ...
                <div>
                  <div className='product-tags d-flex flex-wrap align-items-center gap-10'>
                    <span className='badge bg-light text-secondary rounded-3 py-1 px-2'>
                      Headphones
                    </span>
              ...
              <div className='filter-card mb-3'>
                ...
                <div>
                  <div className='random-products d-flex mb-3'>
                    ...
                    <div className='w-50'>
                      <h5>
                        Kids headphone bulk 10 pack multi colorred for student
                      </h5>
                      <ReactStars
                        count={5}
            ...
            <div className='col-9'>
              <div className='filter-sort-grid mb-4'>
                <div className='d-flex justify-content-between align-items-center'>
                  <div className='d-flex align-items-center gap-10'>
                    <p className='mb-0' style={{ width: "75px" }}>Sort By:</p>
                    <select name='' className='form-control form-select' id=''>
                      ...
                      <option value='price-descending'>Price, hign to low</option>
